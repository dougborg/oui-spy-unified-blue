...
// Operating modes
enum OperatingMode { CONFIG_MODE, TRACKING_MODE };
            ...
            <div class="section">
                ...
                <div class="toggle-container">
                    <div class="toggle-item">
                        <input type="checkbox" id="buzzerEnabled" name="buzzerEnabled" )html" +
                  String(buzzerEnabled ? "checked" : "") + R"html(>
                    ...
                    <div class="toggle-item">
                        <input type="checkbox" id="ledEnabled" name="ledEnabled" )html" +
                  String(ledEnabled ? "checked" : "") + R"html(>
...
void loop() {
    ...
    if (currentMode == CONFIG_MODE) {
        ...
        if (targetDetected &&
            (currentTime - lastTargetSeen < 5000)) { // Target seen within last 5 seconds
            handleProximityBeeping();

            // Print RSSI for visual fox hunting feedback (reduced frequency for real-time
            // performance)
